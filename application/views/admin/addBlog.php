<script src="<?php echo base_url(); ?>assets/tinymce/jquery.tinymce.min.js" referrerpolicy="origin"></script>
    ...
    plugins: [ 'quickbars','link','media','template','autoresize','autolink' ],
...
<div class="row margin-table" style="min-height:100%;">
    <div class="col s12 margin-table" >
      <div id="html-validations" class="card card-tabs">
        <div class="card-content margin-table">
...
echo form_open_multipart('users/addBlog', $attributes);?>
           <div>
            ...
            <!-- this is url  -->
                <div class="input-field col s7">
                  <label for="curl0" class="">Showcase Image </label>
                  <input  aria-required="true" type="text" id="curl0"   name="url">
                  <div class="error"></div>
                </div>
                <!-- browse -->
                ...
                <?php if($this->session->user_type == 'ADMIN'){ ?>          
                    <div class="input-field col s12">
                      <label for="redirect" class="">Redirect URL *</label>
                            <input class="" required="" aria-required="true" id="redirect" type="url" name="redirect">                                   
                  </div>
                <?php }?>
                <div class="input-field col s12 row">
                    <div class=" col s6">
                    <label>
                      <input name="blog_type" type="radio" value="PUBLIC" checked/>
                        <span>Public</span>
                    </label>
                    </div>
                    <div class="col s6">
                    <label>
                      <input name="blog_type" type="radio" value="PRIVATE" />
                        <span>Private</span>
                    </label>
                    </div>

                        ...
                        <div id="sidebar-list" class="sidebar-menu list-group position-relative animate fadeLeft">
                          <div class="sidebar-list-padding app-sidebar sidenav" id="email-sidenav">
                            <ul class="email-list display-grid">
                              ...
                              <li class="active blogSidebar"><a href="<?php echo base_url() ?>users/publish" class="text-sub">Published</a></li>
                              <li><a href="<?php echo base_url() ?>users/unPublish" class="text-sub">Unpublished</a></li>
                            </ul>
                          </div>
                        </div>
                            ...
                            <div class="col s12 m12 l12">
                              <div id="button-trigger" class="card card card-default scrollspy">
                                <div class="card-content">
                                  ...
                                  <div class="row">
                                    <div class="col s12">
                                      <table id="page-length-option8" class="display" >
                                        <thead>
                                          <tr>

                      ...
                      <div class="sidebar-content">
                        <div class="sidebar-header">
                          <div class="sidebar-details">
                            <h5 class=" sidebar-title"><i class="material-icons dp48 app-header-icon text-top blogicon">account_circle</i> User Blogs</h5>
                        ...
                        <div id="sidebar-list" class="sidebar-menu list-group position-relative  animate fadeLeft">
                          <div class="sidebar-list-padding app-sidebar sidenav"  id="email-sidenav">
                            <ul class="email-list display-grid">
                              <li class="active blogSidebar"><a href="">Published Blogs<span class="badge badge pill red" style="padding:0 3px;"><?php echo $count; ?></span></a></li>
                              <li><a href="<?php echo base_url() ?>blog/unpublishblogList" style="width:239px;">Unpublished Blogs<span class="badge badge pill red"><?php echo $countUnpublish; ?></span></a></li>
                              <li><a href="<?php echo base_url() ?>blog/rejectblogList" style="width:239px;">Rejected Blogs<span class="badge badge pill red"><?php echo $rejectblogListCount; ?></span></a></li>
                      ...
                      <div class="col s12 m12 l12" >
                        <div id="button-trigger" class="card card  scrollspy">
                          <div class="card-content">
                            ...
                            <div class="row">
                              <div class="col s12">
                              <table id="page-length-option11" class="display">
                                  <thead>
                                    <tr>
...
$(document).ready(function() {
    ...
    {  
      ...
      if ($(this).hasClass("gradient-45deg-red-pink")) {
             $("#mh").html("Unpublish Blog");
             $("#mp").html("Are you sure you want to Unpublish this blog?");
             $("#action").attr("href",BASE_URL+"blog/unpublish?id="+id);

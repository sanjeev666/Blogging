                        ...
                        <div id="sidebar-list" class="sidebar-menu list-group position-relative  animate fadeLeft">
                          <div class="sidebar-list-padding app-sidebar sidenav"  id="email-sidenav">
                            <ul class="email-list display-grid">
                              ...
                              <li class="active blogSidebar"><a href="" style="width:239px;">Blocked Blogs<span class="badge badge pill red"><?php echo $BlockblogListCount; ?></span></a></li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div class="col s12 m12 l12">
                        <div id="button-trigger" class="card card  scrollspy">
                          <div class="card-content" >
                            <h4 class="card-title">Blocked Blogs</h4>
                            <div class="row">
                              <div class="col s12">
                              <table id="page-length-option13" class="display">
                                  <thead>
                                    <tr>
...
$(document).ready(function() {
    ...
    {   
        ...
        else if($(this).hasClass("gradient-45deg-red-pink"))
        {

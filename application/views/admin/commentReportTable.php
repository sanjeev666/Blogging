                    ...
                    <div class="row">
                      <div class="col s12">
                        <div id="button-trigger" class="card card card-default scrollspy">
                          ...
                          <h5 class="card-title">Comment Reports</h5>
                            <div class="row">
                              <div class="col s12"> 
                                <table id="page-length-option33" class="display">
                                <thead>
                                    <tr>
...
$(document).ready(function() {
    ...
    {   
        ...
        if ($(this).hasClass("gradient-45deg-red-pink")) {
             $("#mh").html("Delete comment");
             $("#mp").html("Are you sure you want to Delete this comment?");
             $("#action").attr("href",BASE_URL+"blog/deltecomment/"+id);
    ...
    $(document).on('click','.usersListing', function () {
      ...
      $('#modal2').modal('open');
            $.ajax({
              type: "POST",
              url: base_url+'blog/commentReportListusers',
              data: {
                    comment_id:usersListing_blog_id
              },
              dataType: "json",
